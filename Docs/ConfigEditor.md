...
* **Slots** — click a slot to pick which card goes there (or None). Card choices include Disk II, BazFast, Appletini (slot 7), Mockingboard, [Uthernet II](Cards_UthernetII.md), [Super Serial](Cards_SuperSerial.md), [Apple Mouse](Cards_AppleMouse.md), [Parallel](Cards_Parallel.md), [Video Overlay Card](Cards_VOC.md) (IIgs slot 3), and others.

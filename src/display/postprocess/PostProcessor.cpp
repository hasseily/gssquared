...
struct PostProcessor::Impl {
    ...
    bool resize(int w,int h) {
        ...
        cleanup_targets();
        // Retain native high-resolution guest overlays until the final CRT pass.
    ...
    Uniforms uniforms() {
        ...
        bool merge=s.bHalveFramerate&&!frame.fields_already_composed; // Do not combine decoded fields a second time.

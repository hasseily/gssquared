...
static const DeviceInfo_t DeviceInfos[NUM_DEVICE_IDS - 1] = {
    ...
    {DEVICE_ID_RTC_PRAM, "RTC (Clock + Battery RAM)", false, 0, PLATFLAG_ANY_IIGS},
    {DEVICE_ID_KEYGLOO, "ADB (KeyGloo)", false, 0, PLATFLAG_ANY_IIGS},
    {DEVICE_ID_ENSONIQ, "Ensoniq", false, 0, PLATFLAG_ANY_IIGS},
    ...
    {DEVICE_ID_APPLETINI, "Appletini", false, 0b10000000, PLATFLAG_ALL},
};
